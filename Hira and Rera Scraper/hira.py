...
def find_unsavedProjects():
    projectList=[]
    url = "http://www.hira.wb.gov.in/district_project.php?dcode=0"
    headers = {
    ...
    try:
        ...
        for project in projects:
            link="http://hira.wb.gov.in/"+project.find_all("td")[2].a["href"]
...
def create_dict_for_project(listt):
    ...
    project_dict = {
        ...
        "mechanical_parking": p_tag[7].b.text,
        "open_car_parking": p_tag[5].b.text,
        "covered_car_parking": p_tag[6].b.text,
        ...
        "email_id": None,  # filled after on code
        "website": None, #fills after,
        "land_area": p_tag[2].b.text.split(",")[0], #sorunlu
        "number of apartmens":None
    }
    if p_tag[3].b:
        project_dict["website"] = p_tag[3].b.text
    try:
...
for index,link in enumerate(find_unsavedProjects()[:25]):
